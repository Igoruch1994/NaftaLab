...
plotdata1 <- cleanframe[cleanframe["Date"]=="2007-02-02" | cleanframe["Date"]=="2007-02-03","Sub_metering_1"]
plotdata2 <- cleanframe[cleanframe["Date"]=="2007-02-02" | cleanframe["Date"]=="2007-02-03","Sub_metering_2"]
plotdata3 <- cleanframe[cleanframe["Date"]=="2007-02-02" | cleanframe["Date"]=="2007-02-03","Sub_metering_3"]
#Draw plot
...
# Save 
dev.copy(device = png, filename = 'D:/R_5/Plot3.png', width = 480, height = 480)
dev.off ()
